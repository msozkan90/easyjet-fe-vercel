      ...
      try {
        ...
        if (payload?.transfer_order) {
          setOrderSummary({
            ...
            fullfillment_location: payload?.transfer_order?.fullfillment_location || null,
          });
        }
      ...
      <div className="space-y-4 p-4">
        ...
        {orderSummary ? (
          <Card className="rounded-2xl border border-slate-100">
            ...
            {orderSummary?.fullfillment_location ? (
              <Alert
                className="mt-3"
                type="info"
                showIcon
                message={`${tOrders("columns.localPickup")}: ${orderSummary.fullfillment_location}`}
              />
            ) : null}
          </Card>
        ) : null}
