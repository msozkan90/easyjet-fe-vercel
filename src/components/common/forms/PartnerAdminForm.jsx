...
export default function PartnerAdminForm({
  ...
  const tForm = useTranslations("forms.partnerAdmin");
  ...
  return (
    ...
    >
      ...
      {mode === "create" && (
        ...
        >
          <Select
            ...
            placeholder={tCommonForms("placeholders.selectPartner")}
      ...
      <Form.Item name="role_code" label={tForm("labels.role")}>
        <Select
          disabled
          options={[{ value: RoleEnum.PARTNER_ADMIN, label: tRoles("partnerAdmin") }]}
        />
      </Form.Item>
